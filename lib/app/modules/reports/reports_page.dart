...
class ReportsPage extends StatelessWidget {
  ...
  ReportsPage({required this.repository});
                ...
                children: [
                  ...
                  if (repository.reportType == ReportType.daily)
                    DropdownButton(
                        ...
                        items:
                            repository.businessModel.businessCashFlow.map((cf) {
                          return DropdownMenuItem(
                            value: cf,
                            child: Text(
          ...
          if (repository.reportType == ReportType.monthly)
            Wrap(
              children: [
                CardReport(
                  title: "Receita total",
                  text: monthReportModel.totalIncome.toString(),
                ),
                CardReport(
                  title: "Despesa total",
                  text: monthReportModel.totalExpense.toString(),
                )
              ],
            ),
          TextButton.icon(
